pipeline {
    ...
    environment {
        ...
        REMOTE_PATH="com/example/demo-webapp/1.0.1/demo-webapp-1.0.0-SNAPSHOT.war"
        LOCAL_PATH="/tmp/demo-webapp-1.0.0-SNAPSHOT.war"
        ARTIFACT_URL = "https://innoimpex.jfrog.io/artifactory/maven-libs-release-local/com/example/demo-webapp/1.0.0-SNAPSHOT/demo-webapp-1.0.0-SNAPSHOT.war"
        OUTPUT_FILE  = "demo-webapp-1.0.0-SNAPSHOT.war"
    }
